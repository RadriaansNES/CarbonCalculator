...
- Water Usage: Assess water consumption and its environmental implications.
- Energy Usage: Measure the carbon footprint of your energy consumption.
- Waste Contribution: Track your waste generation and disposal practices.
- Emissions Due to Vacations: Estimate the impact of your travel choices on the environment.

### Recommendations for Sustainability:
Based on your calculated metrics, YourCarbonFootprint offers personalized recommendations to help you reduce your carbon footprint and adopt more sustainable practices. These recommendations cover areas like transportation alternatives, energy-saving tips, waste reduction strategies, and more.
...
### Recently Calculated Footprints by the Community:
Stay updated with the latest carbon footprint calculations shared by the YourCarbonFootprint community. Discover new ideas and practices that can help you lead a more eco-friendly lifestyle.

### User Profiles and Community Building:
...
## How To Run Locally:
Clone the repository to your local machine. Next navigate through the backend directory into the static directory. Run the command 'npm install' to download the angular related depencies. Next, navigate back up to /backend. Run the command 'mvn install' to install the maven related dependencies. Next, run 'mvn spring-boot:run' to boot the application. This wwill require an .env file with a DATABASE_URL, DATABASE_USERNAME, and DATABASE_PASSWORD. 
